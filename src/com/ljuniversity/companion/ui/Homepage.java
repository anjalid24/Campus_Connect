...
final class HomePageSwing {
    ...
    public static void show() {
        ...
        // Logo (top right) - Loading from classpath (assuming img.png is the college logo)
        ImageIcon scaledLogoIcon = null;
        try {
            ImageIcon originalLogoIcon = new ImageIcon(HomePageSwing.class.getResource("/src/resource/img.png"));
            Image originalLogoImage = originalLogoIcon.getImage();
            Image newImg = originalLogoImage.getScaledInstance(50, 50, Image.SCALE_SMOOTH);
            scaledLogoIcon = new ImageIcon(newImg);
        } catch (Exception e) {
            System.err.println("Home Page: Error loading logo /img.png from classpath.");
    ...
    private static List<String> getRecentWinners(int limit) {
        ...
        try {
            ...
            System.err.println("JDBC Driver not found. Please add MySQL Connector/J JAR.");
            return winners;
        }
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            ...
            System.err.println("Database Error connecting for winners: " + e.getMessage());
        }
        return winners;
    }
    ...
    /**
     * Creates a feature button for the options grid and handles navigation.
     */
        ...
        button.addActionListener(e -> {
            switch (text) {
                ...
                case "Career Guidance":
                    parentFrame.setVisible(false);
                    new CareerGuidance().main(new String[]{});
                    break;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new LoginPageSwing().setVisible(true)); // Starts the login page
    }
}